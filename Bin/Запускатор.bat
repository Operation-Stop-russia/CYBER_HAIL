...
:m1
Echo    ╔═════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
Echo    ║ Operation "Stop russia"                            КIБЕР ГРАД                                IT ARMY of UKRAINE ║
Echo    ╠═════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
Echo    ║                                                                                                                 ║
Echo    ║    Увага! Для успiшного розгортання має бути встановлений i пропатчений GoogleCloudSDK та виконана процедура    ║
Echo    ║    iнiцiалiзацiї/авторизацiї акаунтiв (gcloud init) !!!                                                         ║
...
Echo    ║                                                                                           ▓▓▓▓▓▓▓               ║
Echo    ║    введiть "1" для запуску 25  сеансiв (акаунти 1-25  (перший комплект))            ░░░░▒▒▒▒▒▒▒▒░░░             ║
Echo    ║    введiть "2" для запуску 50  сеансiв (акаунти 1-50  (перший комплект))        ░░░░░░▒▒▒▒▒▒▒▒▒░░░░░░░░         ║
Echo    ║    введiть "3" для запуску 100 сеансiв (акаунти 1-100 (перший комплект))        ░░░░▒▒▒▒▒▒▒▒▒▒░░░░░░░░░         ║
Echo    ║    введiть "4" для запуску 200 сеансiв (акаунти 1-200 (перший комплект))        ░░▒▒▒███▒▒█████████▒▒▒▒▓▓▓▓▓▓   ║
Echo    ║                                                                                 ▒▒▒▒▒███▒▒▒▒▒███▒▒▒▒▒▒▒▓▓▓▓     ║
Echo    ║    вiдповiдно:                                                                ▓▓▒▒▒▒▒███▒▒▒▒▒███▒▒▒▒▒▒▒▓▓       ║
Echo    ║    команда "11"  - 25  сеансiв (акаунти 26-50   (другий комплект))          ▓▓▓▓▒▒▒▒▒███▒▒▒▒▒███▒▒▒▒▒▒▒         ║
Echo    ║    команда "111" - 25  сеансiв (акаунти 51-75   (третiй комплект))        ▓▓▓▓▓▓▒▒▒▒▒███▒▒▒▒▒███▒▒▒▒▒░░         ║
Echo    ║    команда "22"  - 50  сеансiв (акаунти 51-100  (другий комплект))               ░░░░░░░░▒▒▒▒▒▒▒▒▒▒░░░          ║
Echo    ║    команда "222" - 50  сеансiв (акаунти 101-150 (третiй комплект))                ░░░░░░▒▒▒▒▒▒▒▒▒░░░░           ║
Echo    ║    команда "33"  - 100 сеансiв (акаунти 101-200 (другий комплект))                  ░░░▒▒▒▒▒▒▒▒░░░░             ║
Echo    ║    команда "333" - 100 сеансiв (акаунти 201-301 (третiй комплект))                    ▓▒▒▒▒▒▒░░░                ║
Echo    ║    команда "44"  - 200 сеансiв (акаунти 201-400 (другий комплект))                   ▓▓▓▓▓▓                     ║
Echo    ║    команда "444" - 200 сеансiв (акаунти 401-600 (третiй комплект))                  ▓▓▓▓▓                       ║
Echo    ║                                                                                                                 ║
...
if "%choice%"=="01" (Start cmd.exe /k "(echo 1 && <nul set/p "=list") | gcloud init --skip-diagnostics && echo No need && echo. && echo Виведено список авторизованих акаунтiв. Щоб закрити натиснiть будь-яку кнопку && pause && exit") && echo Рекомендується одразу додати всi три комплекти акаунтiв && goto m1
...
if "%choice%"=="3210" echo Iнiцiйовано процес вiдкликання токенiв та видалення iнформацiї про авторизованi акаунти. Для вiдмiни закрийте термiнал. && echo Щоб продовжити натиснiть будь-яку кнопку && pause && gcloud auth revoke --all && pause && Start "" "Bin\Запускатор.bat" 
