...
Echo    บ                                                                                              ฒฒฒฒฒ              บ
Echo    บ    To deploy and launch attack:                                                            ฒฒฒฒฒฒ               บ
Echo    บ                                                                                          ฒฒฒฒฒฒฒ                บ
Echo    บ    enter "1" to start 25  sessions  (accounts 1-25 (first set))                    ฐฐฐฐฑฑฑฑฑฑฑฑฐฐฐ              บ
Echo    บ    enter "2" to start 50  sessions  (accounts 1-50 (first set))                ฐฐฐฐฐฐฑฑฑฑฑฑฑฑฑฐฐฐฐฐฐฐฐ          บ
Echo    บ    enter "3" to start 100 sessions (accounts 1-100 (first set))                ฐฐฐฐฑฑฑฑฑฑฑฑฑฑฐฐฐฐฐฐฐฐฐ          บ
Echo    บ    enter "4" to start 200 sessions (accounts 1-200 (first set))                ฐฐฑฑฑÛÛÛฑฑÛÛÛÛÛÛÛÛÛฑฑฑฑฒฒฒฒฒฒ    บ
Echo    บ                                                                                ฑฑฑฑฑÛÛÛฑฑฑฑฑÛÛÛฑฑฑฑฑฑฑฒฒฒฒ      บ
Echo    บ    respectively:                                                             ฒฒฑฑฑฑฑÛÛÛฑฑฑฑฑÛÛÛฑฑฑฑฑฑฑฒฒ        บ
Echo    บ    "11"  - 25  sessions (accounts 26-50   (second set))                    ฒฒฒฒฑฑฑฑฑÛÛÛฑฑฑฑฑÛÛÛฑฑฑฑฑฑฑ          บ
Echo    บ    "111" - 25  sessions (accounts 51-75   (third set))                   ฒฒฒฒฒฒฑฑฑฑฑÛÛÛฑฑฑฑฑÛÛÛฑฑฑฑฑฐฐ          บ
Echo    บ    "22"  - 50  sessions (accounts 51-100  (second set))                         ฐฐฐฐฐฐฐฐฑฑฑฑฑฑฑฑฑฑฐฐฐ           บ
Echo    บ    "222" - 50  sessions (accounts 101-150 (third set))                           ฐฐฐฐฐฐฑฑฑฑฑฑฑฑฑฐฐฐฐ            บ
Echo    บ    "33"  - 100 sessions (accounts 101-200 (second set))                            ฐฐฐฑฑฑฑฑฑฑฑฐฐฐฐ              บ
Echo    บ    "333" - 100 sessions (accounts 201-301 (third set))                               ฒฑฑฑฑฑฑฐฐฐ                 บ
Echo    บ    "44"  - 200 sessions (accounts 201-400 (second set))                             ฒฒฒฒฒฒ                      บ
Echo    บ    "444" - 200 sessions (accounts 401-600 (third set))                             ฒฒฒฒฒ                        บ
Echo    บ                                                                                                                 บ
