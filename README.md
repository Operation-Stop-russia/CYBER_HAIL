...
Процес додавання акаунтів вдалось автоматизувати тільки частково. gcloud_init.bat (*00 в меню Запускатора*) та копіпастити або застосувати [MacroRecorder](https://www.macrorecorder.com/MacroRecorder_Portable.zip) (*нічого краще за gcloud_init.bat + MacroRecorder покищо реалізувати не вдалось... опис та свій макрос-клікер додам*)     
